...
concat_nframes = (
    3    # the number of frames to concat with, n must be odd (total 2k+1 = n frames)
)
train_ratio = (
    0.75  # the ratio of data used for training, the rest will be used for validation
)
